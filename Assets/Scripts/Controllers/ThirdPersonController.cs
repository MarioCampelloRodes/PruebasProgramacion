...
public class ThirdPersonController : MonoBehaviour
{
    ...
    //MODIFICACIÓN PARA USAR LOS CONSUMIBLES
    void ConsumibleUsed(ItemInfo consumable)
    {
        Consumable cons = consumable as Consumable; //Transforma un script en su herencia <También funciona haciendo (Consumable)consumable;>
